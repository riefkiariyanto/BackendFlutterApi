...
(5, 'admin1', 'admin1@admin.com', NULL, '$2y$10$cgEpt6bsqnKqYSvnZXKGfe7rZ.ljdoc4JSs7fvsgregWIdMRV8xRK', NULL, '2023-11-20 00:54:17', '2023-11-20 00:54:17');

-- --------------------------------------------------------

--
-- Table structure for table `biodata_toko`
--
...
--
-- Dumping data for table `biodata_toko`
--
...
INSERT INTO `clients` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `status`, `created_at`, `updated_at`) VALUES
(6, 'test1', 'test1@gmail.com', NULL, '$2y$10$cgEpt6bsqnKqYSvnZXKGfe7rZ.ljdoc4JSs7fvsgregWIdMRV8xRK', NULL, 'active', '2023-08-14 21:50:08', '2023-08-14 21:50:08');
...
(17, 6, 'TOSAND Bathing Sand Pasir Mandi Hamsterss', 'hamster', '9500', '1700725209.jpg', 'TOSAND Bathing Sand Pasir Mandi Hamster 500 + 100 GR\r\n\r\nPasir mandi Hamster untuk menjaga agar bulu tidak lembab dan menjadikan bulu hamster tetap bersih dan lembut.', '12', '2023-08-22 06:57:25', '2023-11-23 00:40:09'),
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `email_verified_at`, `password`, `phone`, `address`, `images`, `remember_token`, `status`, `created_at`, `updated_at`) VALUES
(13, 'testya', 'testya', 'testya@gmail.com', NULL, '$2y$10$cgEpt6bsqnKqYSvnZXKGfe7rZ.ljdoc4JSs7fvsgregWIdMRV8xRK', '34342', 'sdsd', NULL, NULL, 'active', '2022-02-06 12:54:27', '2022-09-12 01:19:37');
...
--
-- Indexes for table `biodata_toko`
--
...
--
-- AUTO_INCREMENT for table `biodata_toko`
--
ALTER TABLE `biodata_toko`
...
--
-- Constraints for table `biodata_toko`
--
ALTER TABLE `biodata_toko`
