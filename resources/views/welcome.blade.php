        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                @if (Route::has('client.login'))
                    <div class="">
                        @auth('client')
                            <a href="{{ url('/client/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">client Dashboard</a>
                        @else
                            <a href="{{ route('client.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">client Log in</a>

                            @if (Route::has('register'))
                                <a href="{{ route('client.register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">client Register</a>
                            @endif
                        @endauth
                    </div>
                @endif
